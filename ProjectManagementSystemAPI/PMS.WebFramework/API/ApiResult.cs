...
namespace PMS.WebFramework.API
{
    ...
    {
        public ApiResult(bool isSuccess, ApiResponseStatus apiResponseStatus, string message = null)
        {
            IsSuccess = isSuccess;
        ...
        {
            return new ApiResult(true, ApiResponseStatus.Success);
        }

        public static implicit operator ApiResult(BadRequestResult badRequestResult)
        {
            return new ApiResult(false, ApiResponseStatus.BadRequest);
        }
        ...
        public static implicit operator ApiResult(BadRequestObjectResult badRequestObjectResult)
        {
            ...
            return new ApiResult(false, ApiResponseStatus.BadRequest, message);
        }

        public static implicit operator ApiResult(ContentResult contentResult)
        {
            return new ApiResult(true, ApiResponseStatus.Success, contentResult.Content);
        }

        public static implicit operator ApiResult(NotFoundResult notFoundResult)
        {
            return new ApiResult(false, ApiResponseStatus.NotFound);
        }
    }

    public class ApiResult<TData> : ApiResult where TData : class
    {
        public ApiResult(bool isSuccess, ApiResponseStatus apiResponseStatus, TData data, string message = null)
            : base(isSuccess, apiResponseStatus, message)
        {
            Data = data;
        }
        ...
        {
            return new ApiResult<TData>(true, ApiResponseStatus.Success, null);
        }

        public static implicit operator ApiResult<TData>(OkObjectResult okObjectResult)
        {
            return new ApiResult<TData>(true, ApiResponseStatus.Success, (TData)okObjectResult.Value);
        }

        public static implicit operator ApiResult<TData>(BadRequestResult badRequestResult)
        {
            return new ApiResult<TData>(false, ApiResponseStatus.BadRequest, null);
        }
        ...
        public static implicit operator ApiResult<TData>(BadRequestObjectResult badRequestObjectResult)
        {
            ...
            return new ApiResult<TData>(false, ApiResponseStatus.BadRequest, null, message);
        }

        public static implicit operator ApiResult<TData>(ContentResult contentResult)
        {
            return new ApiResult<TData>(true, ApiResponseStatus.Success, null, contentResult.Content);
        }

        public static implicit operator ApiResult<TData>(NotFoundResult notFoundResult)
        {
            return new ApiResult<TData>(false, ApiResponseStatus.NotFound, null);
        }

        public static implicit operator ApiResult<TData>(NotFoundObjectResult notFoundObjectResult)
        {
            return new ApiResult<TData>(false, ApiResponseStatus.NotFound, (TData)notFoundObjectResult.Value);
        }
    }
}
